...
On suppose désormais que $E=F$
 ...
 \begin{dfn}
     On dit que $\phi \in  \Bil(E)$ est \begin{itemize}
         \item Sétrique\index{forme bilinéaire!symétrique} si $\forall  x, y \in  E, \phi(x, y)=\phi(y, x)$ 
         \item Antisymétrique\index{forme bilinéaire!antisymétrique} si $\forall  x, y \in  E, \phi(x, y)=-\phi(y, x)$ 
         \item Aernée\index{forme bilinéaire!alternée} si $\forall  x \in  E, \phi(x, x)=0$
     \end{itemize}
\end{dfn}
...
\section{Interprétation tensorielle}
...
\begin{dfn}
    On appelle carré symétrique de $V$\index{carré symétrique} \[
    \Sym ^2 V=(V\tens V) / X(V)
\] 
et carré extérieur\index{carré extérieur} de  $V$  \[
