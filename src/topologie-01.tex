...
\begin{dfn}
    On dit qu'un espace métrique $(X, d)$ est connexe\index{connexe} si on ne peut pas écrire  $X=U\cup V$ où  $U$ et  $V$ sont deux ouverts non-vides disjoints. Ceci est équivalent à dire que toute fonction continue  $f: X \longrightarrow \{0,1\}$ est constante
\end{dfn}
...
\begin{dfn}
    La composante connexe\index{composante connexe} de $a \in  X$, notée $C(a)$, est l'union des parties connexes de  $X$ qui contiennent  $a$
\end{dfn}
...
\begin{dfn}
    On dit que $X$ est totalement déconnecté\index{totalement déconnecté} si la composante connexe de tout point est réduite à ce point. On dit que  $X$ est connexe par arcs\index{connexe par arcs} si pour tous  $a,b \in  X$, il existe une fonction continue $f:[0,1]\longrightarrow X$ telle que $f(0)=a$ et  $f(1)=b$
\end{dfn}
...
\begin{dfn}
    On dit que $X$ est localement connexe par arcs\index{connexe par arcs (localement)}\index{localement connexe par arcs} si pour tous  $x \in  X$, il existe un voisinage de $x$ qui est connexe par arcs.
\end{dfn}
