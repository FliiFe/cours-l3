...
\begin{center}
    ...
    {\huge \bfseries Topologie et Calcul différentiel }\\[0.1cm]
    \rule{\linewidth}{0.5mm} \\[0.4cm]
    ...
    \end{minipage}\\[2cm]
    \vfill
    \includegraphics[width=5cm]{ensl.pdf}\\[1cm]
    \vfill
...
\foreach \i in {00, 01, 02, 03, 04, 05, 06} {%
    \edef\FileName{topologie-\i}%
    \IfFileExists{src/\FileName}{%
       \input{src/\FileName}%
    }
}
